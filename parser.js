...
function peg$parse(input, options) {
  ...
  const peg$startRuleFunctions = {
    Programa: peg$parsePrograma,
  };
  let peg$startRuleFunction = peg$parsePrograma;

  const peg$c0 = "escreva";
  const peg$c1 = "(";
  const peg$c2 = ")";
  const peg$c3 = "\"";
  ...
  const peg$e0 = peg$literalExpectation("escreva", false);
  ...
  function peg$f0(corpo) {
  return { tipo: "PROGRAMA", corpo: corpo };
  }
  function peg$f1(argumento) {
  return {
